...
public interface HCNetSDK extends Library {
    HCNetSDK HC_NET_SDK = Native.load(LibraryLoader.load(), HCNetSDK.class);
    /*** 宏定义 ***/
    //常量
...
//IPC接入参数配置
    ...
    public static class NET_DVR_IPALARMINFO extends Structure {//ipc com.dw.hikvision.alarm info
        public NET_DVR_IPDEVINFO[] struIPDevInfo = new NET_DVR_IPDEVINFO[MAX_IP_DEVICE];            /* IP设备 */
